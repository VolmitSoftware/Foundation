...
public class J {
    ...
    public static <T, R> R attemptFunction(NastyFunction<T, R> r, T param, R onError) {
        try {
            ...
            BukkitFoundation.verbose("Failed to run function: " + e.getMessage());
        }
    ...
    public static void s(Runnable r) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(BukkitFoundation.instance, r);
    }
    ...
    public static void s(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(BukkitFoundation.instance, r, delay);
    }
    ...
    public static int sr(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleSyncRepeatingTask(BukkitFoundation.instance, r, 0, interval);
    }
    ...
    public static void a(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleAsyncDelayedTask(BukkitFoundation.instance, r, delay);
    }
    ...
    public static int ar(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleAsyncRepeatingTask(BukkitFoundation.instance, r, 0, interval);
    }
