...
public class FConst {
    ...
    public static Feedback success(String message, Object... args) {
        return Feedback.builder()
            ...
            .sound(SoundFeedback.builder().sound(Sound.ITEM_ARMOR_EQUIP_DIAMOND).pitch(1.5f).volume(1f).build())
            .build();
    }
    ...
    public static Feedback info(String message, Object... args) {
        return Feedback.builder()
            ...
            .sound(SoundFeedback.builder().sound(Sound.ITEM_ARMOR_EQUIP_LEATHER).pitch(1.5f).volume(1f).build())
            .build();
    }
